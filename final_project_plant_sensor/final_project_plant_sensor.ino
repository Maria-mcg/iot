...
String httpsRequest = "https://hooks.zapier.com/hooks/catch/9062543/oewrs53/"; // your Zapier URL 
...
void send_email(float temperature, int moisture, int light, String warning){
  ...
  if (client.connect(host, 443)) {
    client.println("POST "+httpsRequest+"?warning="+_warning +"%0A"+"temperature="+_temperature +"%0A"+"moisture="+_moisture+"%0A"+"light="+_light+" HTTP/1.1");
